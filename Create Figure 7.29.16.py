...
def takePic(objName):
    ...
    for kk in range(0, 3):
        ...
        bpy.context.scene.render.filepath = mkdir + objName + "_" + rotName[kk] + ".png"
...
def createFigure(figNum, armNum, randScale):
    ...
    for ii in range(1,armNum + 1):
        ...
        #Make Random size
        BodySize = random.uniform(0.05, 0.2)
        bpy.context.object.scale = [BodySize, BodySize, BodySize]
        ...
        #attatch to body and translate to endpoints 
        #no central body
        #if ii > 1:
        #    bpy.context.object.location = points[random.randint(999,len(points))]
        #else:
    ...
    taperObj = ["BalloonTaper", "BulgeTaper", "ShrinkTaper", "SpikeTaper"]
